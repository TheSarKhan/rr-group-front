...
const ProjectDetailTemplate = () => {
  ...
  // Tarixi manual formatlayırıq: gg.aa.yyyy
  let date = "No date";
  if (project.constructDate) {
    const d = new Date(project.constructDate);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={project.content?.slice(0, 150) || 'Project detail page'} 
        />
      </Helmet>
